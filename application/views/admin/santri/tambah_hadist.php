			...
			<div class="col-lg-12 clear-padding-xs">
				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="inner-item">
								<table cellspacing="0" class="display responsive nowrap" id="attendenceDetailedTable" width="100%">
									...
									<tbody>
										...
										<tr>
											<td data-label="Hadist"><?php echo $hadist->nama ?>
											</td>

											<td data-label="Halaman"><?php echo $hadist->offset." Hal" ?>
											</td>
                        ...
                        ?> <a class="<?php echo $class ?>" href="<?php echo base_url('santri/addhadist/'.$hadist->id) ?>"><i class="fa <?php echo $icon ?>"></i></a>
											</td>
										</tr>
										<?php endforeach ?>
									</tbody>
