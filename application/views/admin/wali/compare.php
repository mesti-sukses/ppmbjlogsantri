					...
					<div class="col-md-2">
						<div class="dash-item">
							...
							<div class="inner-item">
								<?php echo form_open() ?><button class="btn btn-success" style="display: block; width: 100%; margin-bottom: 24px;" type="submit">Compare</button> <?php foreach ($santriData as $santri): ?> <label class="switch" style="display: block; width: 100%"><input name="check[]" type="checkbox" value="<?php echo $santri->santri_id ?>"> <span class="slider"><?php echo $santri->nama ?></span></label> <?php endforeach ?>
							</div>
						</div>
					</div>
