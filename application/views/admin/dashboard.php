                    ...
                    <div class="inner-item">
                      <div class="profile-intro">
                        <div class="col-xs-4 col-sm-12 col-md-4 clear-padding">
                          <img src="<?php echo base_url() ?>images/man.svg" alt="user" />
                        </div>
                      ...
                      <div class="profile-details">
                        ...
                        <div class="detail-row">
                          <div class="col-md-6 col-sm-12 col-xs-6 clear-padding">
                            <span>Angkatan</span>
                            <p><?php echo $userData->angkatan ?></p>
                          </div>
                          <div class="col-md-6 col-sm-12 col-xs-6 clear-padding">
                            <span>Kelas</span>
                            <p><?php echo $class ?></p>
                    ...
                    <?php if (($this->session->userdata('level') & 2) == 2): ?>
                      ...
                      <div class="col-sm-6">
                        <div class="stat-item">
                          ...
                          <div class="status">
                            <p class="text-<?php echo $class ?>"><i class="fa fa-pencil-square-o"></i><?php echo $note ?></p>
                          </div>
                          <div class="clearfix"></div>
                        </div>
                      </div>
