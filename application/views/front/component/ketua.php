  ...
  <div class="row principal-intro-row">
    <div class="container">
      ...
      <div class="col-sm-7 principal-intro">
        ...
        <p><?php echo limit_to_numwords($ketuaData->content, 30).'...' ?></p>
        <h6 class="principal-name"><?php echo $ketuaData->nama ?></h6>
        <div>
          <a class="know-more-btn" href="<?php echo base_url($ketuaData->extra) ?>"><i class="fa fa-paper-plane"></i>KNOW MORE</a>
        </div>
      </div>
    </div>
  </div>