...
<div class="row dashboard-top-nav">
  <nav class="top-search col-sm-10" id="pathshalaNavbar" role="navigation">
    ...
    <div class="navbar-header">
      <div class="logo">
        <h5><button class="navbar-toggle pull-right" data-target="#pathshalaNavbarCollapse" data-toggle="collapse" type="button"><i class="fa fa-bars"></i></button> <i class="fa fa-graduation-cap"></i>Baitul Jannah</h5>
      </div>
    </div>
