  ...
  <?php if(!isset($no_menu)) : ?>
    <nav class="top-search col-sm-10" id="pathshalaNavbar" role="navigation">
      ...
      <div class="navbar-header">
        <div class="logo">
          <h5><button class="navbar-toggle pull-right" data-target="#pathshalaNavbarCollapse" data-toggle="collapse" type="button"><i class="fa fa-bars"></i></button> <i class="fa fa-graduation-cap"></i><?php echo $this->data['title']->value ?></h5>
        </div>
      </div>
  ...
  <div class="col-sm-2 notification-area">
    <ul class="top-nav-list">
      <li class="user dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="student-dashboard.html#"><span><img alt="user" src="<?php echo base_url() ?>images/man.svg"><?php echo $this->session->userdata('name') ?><span class="caret"></span></span></a>
